...
<div class="container">
			...
			<div class="span12">
				<div class="btn-group pull-right">
				  ...
				  <ul class="dropdown-menu">
				    ...
				    <li class="divider"></li>
				    <li>
				    	<a href="${restaurant.subdomain}/logout">
	...
	<sec:authorize access="not isAuthenticated()">
	    <a href="<c:url value="${restaurant.subdomain}/login" />" class="btn brn-primary pull-right">Entrar</a>
								...
								<div class="span12 product">
									<header>
										...
										<span class="badge badge-success pull-right">
											R$ ${product.price}
											<sec:authorize access="isAuthenticated() and hasRole('admin')">
											<a href="${restaurant.subdomain}/removeProduct?categoryId=${category.id}&productId=${product.id}" class="removeProduct">
	...
	<div id="addProductModal" class="modal hide fade" tabIndex="-1" role="dialog" aria-hidden="true">
		...
		<div class="modal-body">
			<f:form modelAttribute="product" method="post" action="${restaurant.subdomain}/addProduct">
